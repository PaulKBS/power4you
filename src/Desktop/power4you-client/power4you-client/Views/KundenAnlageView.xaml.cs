...
namespace power4you_client.Views
{
    public partial class KundenAnlageView : UserControl
    {
        ...
        {
            InitializeComponent();
            VorwahlComboBox.SelectedIndex = 0;
        }
        ...
        private void AbbrechenButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            VornameTextBox.BorderBrush = defaultBorderBrush;
            NachnameTextBox.BorderBrush = defaultBorderBrush;
            StrasseTextBox.BorderBrush = defaultBorderBrush;
            HausnummerTextBox.BorderBrush = defaultBorderBrush;
            PlzTextBox.BorderBrush = defaultBorderBrush;
            OrtTextBox.BorderBrush = defaultBorderBrush;
        ...
        private void KundeAnlegenButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (!isValid)
            {
                MessageBox.Show("Bitte füllen Sie alle Pflichtfelder korrekt aus.", "Validierungsfehler",
                    MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
            ...
            var kundenDaten = new
            {
                ...
                Telefon = $"{((ComboBoxItem)VorwahlComboBox.SelectedItem).Tag} {TelefonTextBox.Text.Trim()}",
                Strasse = StrasseTextBox.Text.Trim(),
                Hausnummer = HausnummerTextBox.Text.Trim(),
                PLZ = PlzTextBox.Text.Trim(),
                Ort = OrtTextBox.Text.Trim()
            };

            MessageBox.Show($"Kunde {kundenDaten.Vorname} {kundenDaten.Nachname} wurde erfolgreich angelegt!",
